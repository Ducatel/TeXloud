...
<article id="monForm">
	<form action="/user/processEditAccount" method="post">
		<fieldset>
			...
			<p>
				<label for="firstname">Prénom : </label> <input type="text"
					id="firstname" name="editAccount[firstname]"
					value="<?php echo htmlspecialchars($var->user->firstname); ?>" />
			</p>
			<p>
				<label for="name">Nom : </label> <input type="text"
					id="name" name="editAccount[lastname]"
					value="<?php echo htmlspecialchars($var->user->lastname);?>" />
			</p>
			<p>
				<label for="gender">Sexe :</label> 
				<input type="radio" name="editAccount[gender]" value="0" <?php echo $var->user->gender==='0'?'checked="checked"':''; ?>/>Homme
				<input type="radio" name="editAccount[gender]" value="1" <?php echo $var->user->gender==='1'?'checked="checked"':''; ?>/>Femme
			</p>
			<p>
				<label for="birthday">Date de naissance : </label> <input
					type="date" id="birthday" class="datenaissance"
					name="editAccount[birthday]"
					value="<?php echo $var->user->date_of_birth; ?>" />

			</p>
			<p>
				<label for="address">Adresse : </label> <input type="text"
					id="address" name="editAccount[address]"
					value="<?php echo htmlspecialchars($var->user->address);?>" />
			</p>

			<p>
				<label for="zip">Code postal : </label> <input
					type="text" id="zip" name="editAccount[zip]"
					value="<?php echo $var->user->zip; ?>" />
			</p>
			<p>
				<label for="city">Ville : </label> <input type="text"
					id="city" name="editAccount[city]"
					value="<?php echo htmlspecialchars($var->user->city);?>" />
			</p>

			<p>
				<label for="country">Pays : </label> <select id="country"
					name="editAccount[country]">
					<?php 
						echo '<option>' . $var->user->country . '</option>';
				 	?>
		...
		<p>
			<label class="form_label_nostyle">&nbsp;</label> <input type="submit"
