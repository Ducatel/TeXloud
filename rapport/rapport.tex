...
\begin{enumerate}
 ...
 \item Compilation du projet\footnote{La gestion du nombre de compilation (edition des liens, bibtex,etc.) nécessaire est effectués par le script Perl latexmk}
