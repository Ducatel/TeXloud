...
Le projet, bien qu'il ne soit pas totalement terminé, est stable, viable et utilisable. Ce projet nous a permit de nous familiariser avec de nouvelles technologies, de nous impliquer dans des conceptions distribuées et ainsi nous formé sur une application réelle.
